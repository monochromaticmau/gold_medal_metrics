...
/*
run npm install and then npm run webpack to compile the front-end files, 
from the root directory of this project. 
To start your server, run node server.js
*/
...
const bestDiscipline = country => {
  return  `SELECT discipline, COUNT(*)
          FROM GoldMedal
          WHERE country = '${country}'
          GROUP BY discipline
          ORDER BY COUNT(*) DESC
